...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("basic_letters.png")            # read in training numbers image
    ...
    intValidChars =[  
                      ...
                      ord('q'),ord('w'),ord('e'),ord('r'),ord('t'),ord('y'),ord('u'),ord('i'),ord('o'),ord('p'),ord('a'),ord('s'),ord('d'),ord('f'),ord('g'),ord('h'),ord('j'),
                      ord('k'),ord('l'),ord('z'),ord('x'),ord('c'),ord('v'),ord('b'),ord('n'),ord('m'),
					  ord('E'),ord('Q'),ord('W'),ord('R'),ord('T'),ord('Y'),ord('U'),ord('I'),ord('O'),ord('P'),ord('A'),ord('S'),ord('D'),ord('F'),ord('G'),ord('H'),ord('J'),
					  ord('K'),ord('L'),ord('Z'),ord('X'),ord('C'),ord('V'),ord('B'),ord('N'),ord('M'),
