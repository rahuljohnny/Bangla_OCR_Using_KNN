...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("f1.png")            # read in training numbers image // 3cha_dha to 5
    ...
    np.savetxt("basic_letters\\f_classifications.txt", npaClassifications)           # write flattened images to file
    np.savetxt("basic_letters\\f_flattened_images.txt", npaFlattenedImages)          #
